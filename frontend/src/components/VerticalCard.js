...
const VerticalCard = ({ loading, data = [] }) => {
    ...
    return (
        <div className='grid grid-cols-[repeat(auto-fit,minmax(300px,320px))] justify-center md:justify-between md:gap-4 overflow-x-scroll scrollbar-none transition-all'>

            {
                loading ? (
                    ...
                    data.map((product, index) => {
                        return (
                            <Link to={"/product/" + product?._id} className="w-full min-w-[280px] my-2 md:min-w-[320px] max-w-[280px] md:max-w-[320px] bg-white rounded-sm shadow cursor-pointer" onClick={scrollTop}>
